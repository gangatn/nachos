...
Cet exemplaire de nachos, a été étendue en mettant principalement l'accent sur la gestion des processus et le système de fichier.

Chaque programme utilisateur peut lancer des forks et des execs de façon indépendante, mais aussi de façon performante grâce à la technique du copie-on-write.

Le système de fichier propose une façon plus créative de gérer les fichiers grâce à un système d'étiquette (appelée tag par la suite). Ce système permet un accès direct aux fichiers sans avoir à passer par une hiérarchie comme sous les systèmes de fichier de type POSIX.

De façon plus classique, nous avons aussi développé une console synchrone et une gestion des processus léger.
