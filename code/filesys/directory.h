...
#ifdef CHANGED
    bool isDir;				// Is the directory entry a directory?
#endif
...
class Directory {
  public:
...
#ifdef CHANGED
    bool AddDirectory(const char *name, int newSector);  // Add a directory into the directory
    ...
    void List();			// Print the names of all the files and
					//  directory in the directory
    void Print();			// Verbose print of the contents
					//  of the directory -- all the file
					//  names and their contents.
#ifdef CHANGED
    int parent;				// Sector of the parent directory (0 if no parent)
#endif
