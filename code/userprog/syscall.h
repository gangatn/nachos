...
/*
 * Attributing id for each system call
 */
...
/*
 * Defining system calls prototypes
 */

#define SYSCALL_PROC(name, handler, ...) void name( __VA_ARGS__ );
#define SYSCALL_FUNC(name, handler, type, ...) type name ( __VA_ARGS__ );
